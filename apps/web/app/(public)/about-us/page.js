      ...
      <section className="px-6 py-20 md:px-16">
        <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
          ...
          >
            ...
            <p className="leading-relaxed text-gray-600">
              We believe that shopping should be enjoyable, convenient, and trustworthy. That is why
      ...
      <section className="bg-gray-100 px-6 py-20 md:px-16">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {companyCoreValues.map((value, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -8 }}
      ...
      <section className="relative px-6 py-20 md:px-16">
        ...
        <div className="relative mx-auto max-w-6xl text-center">
          ...
          <div className="mt-12 grid gap-10 sm:grid-cols-2 md:grid-cols-3">
            {companyTeamMembers.map((member, index) => (
              <motion.div
                key={index}
